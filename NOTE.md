...
Your task is to make the background of the app white instead of slightly purple as it is now and do the same for all the remaining components currently have this slight purple color.
