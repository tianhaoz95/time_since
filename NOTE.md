...
Your task is to modify the login screen UI to make it look like @prototype/login-screen-sample.png, use @prototype/login-screen-pattern.png as the asset for the pattern for the background.
